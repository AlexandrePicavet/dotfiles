-- TODO once the refacto is done remove these configurations:
-- https://github.com/neovim/nvim-lspconfig/issues/3859
-- https://github.com/neovim/nvim-lspconfig/pull/4083
...
--@param upward? boolean # Search upward or not
--@return string|nil
local function get_node_module_dir()
	local root_dir = vim.fn.getcwd()
	local node_modules_dir = vim.fs.find('node_modules', { path = root_dir, upward = true })[1]
	node_modules_dir = node_modules_dir or vim.fs.find('node_modules', { path = root_dir, upward = false })[1]

	return node_modules_dir
end

local node_modules_dir = get_node_module_dir()
